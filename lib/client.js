...
window.__ModuleLoader__.load({
    ...
    factory: function (require) {
        ...
        var inputInvalidStyle = Object.assign({}, inputStyle, { borderColor: "var(--dsw-alias-label-error, var(--dsw-alias-state-error-primary))" });
        ...
        var invalidStyle = { color: "var(--dsw-alias-label-error, var(--dsw-alias-state-error-primary))", margin: 0, fontSize: "12px", lineHeight: 1.5 };
        ...
        var failedStyle = { minWidth: 0, color: "var(--dsw-alias-label-error, var(--dsw-alias-state-error-primary))", flex: 1, margin: 0, fontSize: "12px", lineHeight: 1.5 };
