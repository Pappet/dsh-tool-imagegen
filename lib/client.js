...
window.__ModuleLoader__.load({
    ...
    factory: function (require) {
        ...
        /**
         * One stylesheet, injected once, the way every built-in bundle ships its
         * CSS — a hand-written bundle has no CSS-module build step, but inline
         * React styles are the wrong shape for this: they cannot express `:hover`,
         * `:disabled`, `:focus-visible` or the `+` sibling rule that draws the
         * divider BETWEEN fields, and web-styling.md rules them out for theme
         * branches. Values are semantic `--dsw-alias-*` tokens only; the class
         * prefix keeps the global names ours.
         */
        var CSS_ID = "dsh-tool-imagegen/cards.css";
        var CSS = [
            ".dsi-tool{min-width:0;padding:2px 0}",
            ".dsi-img{display:block;max-width:100%;max-height:360px;border-radius:10px;border:1px solid var(--dsw-alias-border-l2);cursor:zoom-in}",
            ".dsi-caption{color:var(--dsw-alias-label-tertiary);font:400 12px/18px var(--ds-font-family-code, monospace);margin-top:4px;overflow-wrap:anywhere;cursor:pointer}",
            ".dsi-pending{color:var(--dsw-alias-label-tertiary);font:400 13px/20px var(--ds-font-family-code, monospace)}",
            ".dsi-loading{width:100%;max-width:420px;height:120px;display:flex;align-items:center;justify-content:center;border:1px dashed var(--dsw-alias-border-l2);border-radius:10px}",
            ".dsi-card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}",
            ".dsi-card[data-open]{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}",
            ".dsi-head{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}",
            ".dsi-headtext{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}",
            ".dsi-name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}",
            ".dsi-desc{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}",
            ".dsi-pill{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}",
            ".dsi-chev{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}",
            ".dsi-card[data-open] .dsi-chev{transform:rotate(180deg)}",
            ".dsi-body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}",
            ".dsi-readonly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}",
            ".dsi-field{flex-direction:column;gap:6px;padding:12px 0;display:flex}",
            ".dsi-field+.dsi-field{border-top:1px solid var(--dsw-alias-border-l2)}",
            ".dsi-fieldhead{align-items:center;gap:8px;display:flex}",
            ".dsi-label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}",
            ".dsi-badges{align-items:center;gap:8px;display:inline-flex}",
            ".dsi-badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}",
            ".dsi-linkbtn{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}",
            ".dsi-linkbtn:hover:not(:disabled){color:var(--dsw-alias-label-primary)}",
            ".dsi-linkbtn:disabled{cursor:default;opacity:.4}",
            ".dsi-add{align-self:flex-start}",
            ".dsi-input{box-sizing:border-box;width:100%;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}",
            ".dsi-input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}",
            ".dsi-input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}",
            ".dsi-input[aria-invalid]{border-color:var(--dsw-alias-label-error, var(--dsw-alias-state-error-primary))}",
            ".dsi-check{width:16px;height:16px;margin:9px 0;accent-color:var(--dsw-alias-brand-primary)}",
            ".dsi-check:disabled{cursor:default}",
            ".dsi-hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}",
            ".dsi-error{color:var(--dsw-alias-label-error, var(--dsw-alias-state-error-primary));margin:0;font-size:12px;line-height:1.5}",
            ".dsi-rowerror{margin-bottom:8px}",
            ".dsi-row{display:grid;grid-template-columns:1fr 1.4fr 1.6fr auto;gap:8px;align-items:center;margin-bottom:8px}",
            ".dsi-rowhead{margin-bottom:4px}",
            ".dsi-footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}",
            ".dsi-failed{min-width:0;color:var(--dsw-alias-label-error, var(--dsw-alias-state-error-primary));flex:1;margin:0;font-size:12px;line-height:1.5}",
            ".dsi-btn{appearance:none;font:inherit;cursor:pointer;border:1px solid var(--dsw-alias-border-l2);border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5;color:var(--dsw-alias-label-secondary);background:0 0}",
            ".dsi-btn:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}",
            ".dsi-btn-primary{border-color:transparent;background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}",
            ".dsi-btn:disabled{opacity:.4;cursor:default}",
            ".dsi-btn:focus-visible,.dsi-linkbtn:focus-visible,.dsi-head:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}",
        ].join("\n");

        if (typeof document !== "undefined"
            && document.querySelector("style[data-plugin-css=" + JSON.stringify(CSS_ID) + "]") === null) {
            var styleTag = document.createElement("style");
            styleTag.dataset.plugin = "dsh-tool-imagegen";
        ...
        function ImageCard(props) {
            ...
            if (!meta) {
                ...
                return e("div", { className: "dsi-tool", "data-tool": "generate_image" },
                    e("div", { className: "dsi-pending" },
            ...
            refs.forEach(function (ref) {
                ...
                if (url) {
                    ...
                    children.push(e("div", {
                        ...
                        className: "dsi-pending dsi-loading",
            ...
            return e("div", { className: "dsi-tool", "data-tool": "generate_image" }, children);
        }
        ...
        function Chevron() {
            return e("svg", {
                width: 14, height: 14, viewBox: "0 0 14 14", "aria-hidden": true, className: "dsi-chev",
            }, e("path", {
        ...
        function Field(props) {
            ...
            var t = props.t;
            return e("div", { className: "dsi-field" },
                e("div", { className: "dsi-fieldhead" },
                    e("label", { htmlFor: id, className: "dsi-label" }, t("label_" + spec.key)),
                    props.overridden
                        ? e("span", { className: "dsi-badges" },
                            e("span", { className: "dsi-badge" }, t("overridden")),
                            e("button", {
                                type: "button", className: "dsi-linkbtn", disabled: props.disabled, onClick: props.onReset,
                            }, t("reset")))
                        : null),
                control,
                e("p", { className: props.invalid ? "dsi-error" : "dsi-hint" },
                    props.invalid
        ...
        function SettingsCard(props) {
            ...
            if (snapshot.status === "loading" || snapshot.status === "unavailable" || !value) {
                return e("li", { className: "dsi-card", "data-plugin-card": NS },
                    e("div", { className: "dsi-head" },
                        e("span", { className: "dsi-headtext" },
                            e("span", { className: "dsi-name" }, t("title")),
                            e("span", { className: "dsi-desc" },
            ...
            return e("li", {
                className: "dsi-card", "data-open": open || undefined,
                "data-plugin-card": NS,
            },
                e("button", {
                    type: "button", className: "dsi-head", "aria-expanded": open,
                    onClick: function () { openPair[1](!open); },
                },
                    e("span", { className: "dsi-headtext" },
                        e("span", { className: "dsi-name" }, t("title")),
                        e("span", { className: "dsi-desc" }, t("description"))),
                    dirty ? e("span", { className: "dsi-pill" }, t("unsaved")) : null,
                    e(Chevron, null)),
                open ? e("div", { className: "dsi-body" },
                    !snapshot.writable
                        ? e("p", { className: "dsi-readonly", role: "status" }, t("readOnly"))
                        : null,
                    e("div", null,
                    ...
                    e("div", { className: "dsi-field" },
                        e("div", { className: "dsi-fieldhead" },
                            e("label", { className: "dsi-label" }, t("modelsLabel")),
                            isOverridden(snapshot.user, "models")
                                ? e("span", { className: "dsi-badges" },
                                    e("span", { className: "dsi-badge" }, t("overridden")),
                                    e("button", {
                                        type: "button", className: "dsi-linkbtn", disabled: disabled,
                                        onClick: function () { write(function () { return scope.unset("models"); }); },
                                    }, t("reset")))
                                : null),
                        e("div", { className: "dsi-row dsi-rowhead" },
                            e("span", { className: "dsi-hint" }, t("colAlias")),
                            e("span", { className: "dsi-hint" }, t("colId")),
                            e("span", { className: "dsi-hint" }, t("colDefaults")),
                            e("span", null, "")),
                        currentRows.map(function (row, i) {
                            var rowInvalid = problems[i] ? true : undefined;
                            return e("div", { key: row.key },
                                e("div", { className: "dsi-row" },
                                    e("input", {
                                        type: "text", value: row.alias, disabled: disabled, className: "dsi-input", "aria-invalid": rowInvalid,
                                        onChange: function (ev) { setRow(i, { alias: ev.target.value }); },
                                    }),
                                    e("input", {
                                        type: "text", value: row.id, disabled: disabled, className: "dsi-input", "aria-invalid": rowInvalid,
                                        placeholder: t("placeholderId"),
                                        onChange: function (ev) { setRow(i, { id: ev.target.value }); },
                                    }),
                                    e("input", {
                                        type: "text", value: row.defaultsText, disabled: disabled, className: "dsi-input", "aria-invalid": rowInvalid,
                                ...
                                problems[i]
                                    ? e("p", { className: "dsi-error dsi-rowerror" }, t(problems[i]))
                                    : null);
                        }),
                        e("button", {
                            type: "button", disabled: disabled, className: "dsi-linkbtn dsi-add",
                            onClick: function () {
                                setRows(currentRows.concat([{ key: "neu-" + Date.now(), alias: "", id: "", defaultsText: "" }]));
                            },
                        }, t("addRow")),
                        e("p", { className: "dsi-hint" }, t("modelsHint")))),
                    e("div", { className: "dsi-footer" },
                        errorPair[0]
                            ? e("p", { className: "dsi-failed", role: "status" }, errorPair[0])
                            : (blocked ? e("p", { className: "dsi-failed", role: "status" }, t("blocked")) : null),
                        e("button", {
                            type: "button",
                            className: "dsi-btn",
        ...
        function apply(ctx) {
            ...
            // Read through ctx.get: a bare `ctx.locale` THROWS for a service
            // this plugin does not inject ("cannot get property … without
            // inject"), and that throw would take the whole client half down,
            // tool card included. Registration is contained for the same
            // reason — a duplicate (ns, locale) throws, and losing the picture
            // over a dictionary would be absurd. Without it every string still
            // resolves, through the English fallback.
            var locale = typeof ctx.get === "function" ? ctx.get("locale") : undefined;
            var localized = false;
            if (locale && typeof locale.register === "function") {
                try {
                    ctx.effect(function () { return locale.register(NS, { zh: zh, en: en }); });
                    localized = true;
                } catch (error) {
                    localized = false;
                }
